...
mod tray {
    ...
    pub fn build(_: &AppHandle) -> tauri::Result<()> {
        Ok(())
    }
    ...
    pub fn current_prefs() -> TrayPrefs {
        TrayPrefs {
            close_to_tray: false,
            always_on_top: false,
    ...
    pub fn tray_set_prefs(_: AppHandle, _: TrayPrefs) {}

    pub fn toggle(_: &AppHandle, _: Pref) {}

    pub fn apply_always_on_top(_: &AppHandle, _: bool) {}
